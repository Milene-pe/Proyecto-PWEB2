...
class Showtime(models.Model):
    ...
    price_general = models.DecimalField(max_digits=4, decimal_places=2)
    price_kids = models.DecimalField(max_digits=4, decimal_places=2)
    price_seniors = models.DecimalField(max_digits=4, decimal_places=2)
